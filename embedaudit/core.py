"""EMBEDAUDIT core — Embedding / vector-store drift and poisoning audit."""
...
RULES = [
    ("EMB-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("EMB-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("EMB-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
