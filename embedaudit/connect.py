"""Native cognis-connect emit for embedaudit — forward findings to any platform.

Maps embedaudit's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    embedaudit ... --format json | embedaudit-emit --to stix
    embedaudit-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
