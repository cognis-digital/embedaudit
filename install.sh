#!/usr/bin/env sh
# Universal installer for embedaudit. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/embedaudit.git"
echo "Installing embedaudit ..."
